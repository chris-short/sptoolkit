...
function listing ($list) {
	...
	<th style="text-align: center; vertical-align: middle"><img src="' . $self . '?image=smiley" width="17" height="13" alt="smiley" /></th>
';
...
';
	...
	<td class="filename" title="' . html($timestamps) . '">';
		...
		if ($file['is_link']) {
			...
			echo '<img src="' . $self . '?image=link" width="17" height="13" alt="link" /> ';
			...
			echo '<img src="' . $self . '?image=folder" width="17" height="13" alt="folder" /> [ ';
			...
			if (substr($file['filename'], 0, 1) == '.') {
				echo '<img src="' . $self . '?image=hidden_file" width="17" height="13" alt="hidden file" /> ';
			} else {
				echo '<img src="' . $self . '?image=file" width="17" height="13" alt="file" /> ';
			}
...
';
	...
	<td style="text-align: right; vertical-align: top"><img src="' . $self . '?image=arrow" width="17" height="13" alt="&gt;" /></td>
	<td colspan="' . ($cols - 1) . '">
