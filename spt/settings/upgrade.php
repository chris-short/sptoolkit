...
move_uploaded_file($_FILES['file']['tmp_name'], '../tmp_upgrade.zip');
//overwrite files and remove zip file
shell_exec('cd ../;unzip -o tmp_upgrade.zip;rm tmp_upgrade.zip');
//fix permissions
shell_exec('cd ../;chmod -R 775 *');
//pass control to install if necessary
if(file_exists('../install.php')){
    header('location:../install.php');
    exit;
}
//send user back with success message
$_SESSION['alert_message'] = "upgrade completed";
header('location:./#tabs-1');
exit;
