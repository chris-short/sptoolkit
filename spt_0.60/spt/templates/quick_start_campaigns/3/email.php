...
$start_date = date( "l, F d, Y", $start_day );

$end_day = mktime( 0, 0, 0, date("m")  , date("d")+26, date("Y") );
$end_date = date( "l, F d, Y", $end_day );
